    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={styles.header}>
          <Text style={styles.headerTitle}>ATLASPM | THEMIS LEGAL DEFENSE</Text>
...
export async function generateThemisPDF(draft: WorkOrderDraftWithRelations): Promise<Buffer> {
